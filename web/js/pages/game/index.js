...
import { blockConfig, colorConfig } from "../../../config.js";
...
class GamePage {
  ...
  handleTouchStart = (e) => {
    if (this.databus.gameOver) {
      // Get touch position safely
      if (!e.changedTouches || !e.changedTouches[0]) return;
      
      const touch = e.changedTouches[0];
      const pageX = touch.pageX !== undefined ? touch.pageX : touch.clientX;
      const pageY = touch.pageY !== undefined ? touch.pageY : touch.clientY;
      
      if (
        this.gameInfo.region &&
